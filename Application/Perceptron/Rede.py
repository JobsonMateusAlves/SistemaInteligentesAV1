...
class Rede:
    ...
    existe_erro = True
    types = [] # A variavel types serve para identificar quais classes serão utilizadas no treinamento


    def __init__(self, qtd_entradas, taxaDeAprendizado, types):
        self.types = types
        self.neuronio = Neuronio(qtd_entradas, taxaDeAprendizado, self.types)
    ...
    def treinar(self, entradas=[[]], respostas=[]):
        ...
        self.filter() #Filtrando as entradas para utilizar apenas as classes escolhidas para fazer o treinamento.
